...
<body>
    ...
    <section id="events" class="py-5">
        <div class="container">
            ...
            <?php
            // Query to check for events
            $events_query = "SELECT * FROM events WHERE event_date >= CURRENT_DATE ORDER BY event_date";
                        ...
                        <div class="event-item">
                            ...
                            <div class="event-content">
                                ...
                                <div class="event-meta">
                                    <span><i class="fas fa-calendar"></i> <?php echo date('F d, Y', strtotime($event['event_date'])); ?></span>
                                ...
                                <?php if (!empty($event['registration_link'])): ?>
                                    <a href="<?php echo htmlspecialchars($event['registration_link']); ?>" class="event-register-btn">Register Now</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endwhile; ?>
            ...
            <?php else: ?>
                <!-- Display placeholder (your existing empty state) -->
                <div class="empty-events-state">
                    <div class="empty-events-content">
                        <div class="calendar-icon">
                            <i class="fas fa-calendar-alt"></i>
                        </div>
                        <div class="empty-events-text">
                            <h3>Stay Tuned for Our Upcoming Events!</h3>
                            <p>We're preparing educational events that will inspire and empower.</p>
                        </div>
                        <div class="event-types">
                            <span><i class="fas fa-graduation-cap"></i> KCSE Workshops</span>
                            <span><i class="fas fa-microscope"></i> Science Labs</span>
                            <span><i class="fas fa-brain"></i> Study Groups</span>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
