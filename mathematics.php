...
<head>
    ...
    <title>Mathematics - AccessEd</title>
...
<body>
    ...
    <div class="resource-tabs text-center">
        <div class="container">
            <a href="#study-materials" class="resource-tab active" data-target="study-materials">Study Materials</a>
            <a href="#past-papers" class="resource-tab" data-target="past-papers">Past Papers</a>
        </div>
    </div>

    <div class="container">
        <!-- Study Materials Section -->
        <div id="study-materials" class="resource-content active">
            <?php if (empty($resources['notes'])): ?>
                <div class="empty-state">
                    <i class="fas fa-book-open"></i>
                    <h3>No Study Materials Available</h3>
                    <p>Check back later for study materials and notes.</p>
                </div>
            <?php else: ?>
                <div class="row">
        ...
        <!-- Past Papers Section -->
        <div id="past-papers" class="resource-content">
            <?php if (empty($resources['past_paper'])): ?>
                <div class="empty-state">
                    <i class="fas fa-file-alt"></i>
                    <h3>No Past Papers Available</h3>
                    <p>Check back later for past examination papers.</p>
                </div>
            <?php else: ?>
                <div class="row">
